...
/// Serialized: each of these spins a core at 100% for its budget. Seven at once on a
/// three-core runner is a stall, not a test.
@Suite(.serialized) struct ExecutionWatchdogTests {

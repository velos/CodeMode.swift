...
@Test func canonicalToolDescriptionsExposeRecommendedNames() {
    ...
    #expect(CodeModeAgentToolDescriptions.searchJavaScriptAPI.description.contains("capabilityKey"))
    #expect(CodeModeAgentToolDescriptions.searchJavaScriptAPI.description.contains("builtInCapability"))
    ...
    #expect(CodeModeAgentToolDescriptions.searchJavaScriptAPI.description.contains(".slice(0, 10)"))
    ...
    #expect(CodeModeAgentToolDescriptions.executeJavaScriptParameterSchema.objectValue?.object("properties")?.object("allowedCapabilityKeys") != nil)
    #expect(CodeModeAgentToolDescriptions.executeJavaScript.description.contains("allowedCapabilities"))
    #expect(CodeModeAgentToolDescriptions.executeJavaScript.description.contains("allowedCapabilityKeys"))
    ...
    #expect(CodeModeAgentToolDescriptions.executeJavaScript.description.contains("bare final top-level await"))
    #expect(CodeModeAgentToolDescriptions.executeJavaScript.description.contains("10000ms"))
    #expect(CodeModeAgentToolDescriptions.executeJavaScript.description.contains("setTimeout"))
    #expect(CodeModeAgentToolDescriptions.executeJavaScript.description.contains("CAPABILITY_DENIED"))

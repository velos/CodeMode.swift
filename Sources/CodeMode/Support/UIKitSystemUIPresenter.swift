...
@MainActor private final class CalendarChooserCoordinator: NSObject, @preconcurrency EKCalendarChooserDelegate {
...
@MainActor private final class CalendarEventViewCoordinator: NSObject, @preconcurrency EKEventViewDelegate {
...
@MainActor private final class ContactViewCoordinator: NSObject, @preconcurrency CNContactViewControllerDelegate {
    private let onComplete: (CNContact?) -> Void
...
@MainActor private final class DocumentPickerCoordinator: NSObject, UIDocumentPickerDelegate {
...
@MainActor private final class CameraCaptureCoordinator: NSObject, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
...
#if os(iOS) && canImport(VisionKit)
@MainActor private final class DocumentScanCoordinator: NSObject, @preconcurrency VNDocumentCameraViewControllerDelegate {
    private let outputDirectory: URL
...
#if canImport(MessageUI) && os(iOS)
@MainActor private final class MailComposeCoordinator: NSObject, @preconcurrency MFMailComposeViewControllerDelegate {
...
@MainActor private final class MessageComposeCoordinator: NSObject, @preconcurrency MFMessageComposeViewControllerDelegate {
...
#if os(iOS)
@MainActor private final class SafariCoordinator: NSObject, @preconcurrency SFSafariViewControllerDelegate {
    private let onComplete: () -> Void
...
@MainActor private final class WebAuthenticationCoordinator: NSObject, ASWebAuthenticationPresentationContextProviding {

...
extension DefaultCapabilityRegistrationBuilder {
    func visionRegistrations() -> [CapabilityRegistration] {
        [
            CapabilityRegistration(
                .visionImageAnalyze,
                jsName: "apple.vision.analyzeImage",
    ...
    func notificationRegistrations() -> [CapabilityRegistration] {
        [
            CapabilityRegistration(
                ...
                jsName: "apple.notifications.requestPermission",
            ...
            CapabilityRegistration(
                ...
                jsName: "apple.notifications.schedule",
            ...
            CapabilityRegistration(
                ...
                jsName: "apple.notifications.listPending",
            ...
            CapabilityRegistration(
                ...
                jsName: "apple.notifications.cancelPending",
            ...
            CapabilityRegistration(
                ...
                jsName: "apple.notifications.listDelivered",
            ...
            CapabilityRegistration(
                ...
                jsName: "apple.notifications.removeDelivered",
    ...
    func alarmRegistrations() -> [CapabilityRegistration] {
        [
            CapabilityRegistration(
                ...
                jsName: "ios.alarm.requestPermission",
    ...
    func healthRegistrations() -> [CapabilityRegistration] {
        [
            CapabilityRegistration(
                ...
                jsName: "apple.health.requestPermission",
    ...
    func homeRegistrations() -> [CapabilityRegistration] {
        [
            ...
            CapabilityRegistration(
                .homeWrite,
                jsName: "apple.home.writeCharacteristic",
    ...
    func mediaRegistrations() -> [CapabilityRegistration] {
        [
            ...
            CapabilityRegistration(
                .mediaFrameExtract,
                jsName: "apple.media.extractFrame",
